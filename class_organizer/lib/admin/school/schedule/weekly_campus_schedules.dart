...
class WeeklyCampusSchedules extends StatefulWidget {
  final Routine routine;
  WeeklyCampusSchedules({required this.routine});

  @override
  _WeeklyCampusSchedulesState createState() => _WeeklyCampusSchedulesState();
}

class _WeeklyCampusSchedulesState extends State<WeeklyCampusSchedules> {
