...
class TeacherCompanion extends StatefulWidget {
  const TeacherCompanion({super.key});

  @override
  _TeacherCompanionState createState() => _TeacherCompanionState();
}

class _TeacherCompanionState extends State<TeacherCompanion> {
